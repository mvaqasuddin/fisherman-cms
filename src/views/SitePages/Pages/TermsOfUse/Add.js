...
export default function AddTermsOfUse() {
  ...
  const handleImageSelect = (e, index, section) => {
    ...
    if (e.target.checked) {
      ...
      setTermsUse({
        ...termsUse,
        [section]: { ...termsUse[section], section_avatar: imagesData[index] },
      });
      ...
      setTermsUse({
        ...termsUse,
        [section]: { ...termsUse[section], section_avatar: "" },
      });
      setThumbnailPreview("");
  ...
  const handleSubmit = () => {
    ...
    LangAPI.post(`/add-section?lang=${selectedLang}`, updatedTermsUse)
      .then((response) => {
        if (response.status === 200) {
          alert("Section updated successfully !");
        }
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={12}>
                    ...
                    <TextField
                      ...
                      name="section_name"
                      label="Section Title"
                      value={termsUse.banner.section_name}
                      variant="outlined"
                      fullWidth
                    ...
                    <div className="thumbnail-preview-wrapper-large img-thumbnail">
                      ...
                      ) : typeof termsUse.banner.section_avatar?.url ===
                        typeof 0 ? (
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={12}>
                    ...
                    <TextField
                      ...
                      name="section_name"
                      label="Section Title"
                      value={termsUse.intro.section_name}
                      variant="outlined"
                      fullWidth
                    ...
                    <CKEditor
                      ...
                      data={termsUse.intro.section_content}
                      onChange={(e) =>
                        setTermsUse({
                          ...termsUse,
                          intro: {
