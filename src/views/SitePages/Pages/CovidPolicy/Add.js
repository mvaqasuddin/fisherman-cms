...
export default function AddCovidPolicy() {
  ...
  const handleInputChange = (e, section) => {
    let updatedAbout = { ...covidPolicy };
    updatedAbout[section][e.target.name] = e.target.value;
    setCovidPolicy(updatedAbout);
  };
  ...
  const handleImageSelect = (e, index, section) => {
    ...
    if (e.target.checked) {
      ...
      setCovidPolicy({
        ...covidPolicy,
        [section]: { ...covidPolicy[section], section_avatar: "" },
      });
      setThumbnailPreview("");
  ...
  const handleSubmit = () => {
    ...
    LangAPI.post(`/add-section?lang=${selectedLang}`, updatedCovidPolicy)
      .then((response) => {
        if (response.status === 200) {
          alert("Section updated successfully !");
        }
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={12}>
                    ...
                    <div className="thumbnail-preview-wrapper-large img-thumbnail">
                      {!covidPolicy.banner.id > 0 ? (
                        covidPolicy.banner.section_avatar?.url !== "" ? (
                          <img
                            ...
                            alt={covidPolicy.banner.section_avtar_alt || ""}
                          />
                        ) : (
                          <img
                      ...
                      ) : typeof covidPolicy.banner.section_avatar?.url ===
                        typeof 0 ? (
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={12}>
                    ...
                    <CKEditor
                      ...
                      data={covidPolicy.intro.section_content}
                      onChange={(e) =>
                        setCovidPolicy({
                          ...covidPolicy,
                          intro: {
