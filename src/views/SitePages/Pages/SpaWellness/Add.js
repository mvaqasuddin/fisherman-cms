  ...
  useEffect(() => {
    LangAPI.get(`/all-sections/${pageId}/${selectedLang}`).then((response) => {
      if (response?.status === 200) {
        ...
        // setSpaWellness(
        //   {
        //     intro: data.find(x => x.section_slug === "intro") || spaWellness.intro,
        //     banner: data.find(x => x.section_slug === "banner") || spaWellness.banner,
        //     dine: data.find(x => x.section_slug === "dine") || spaWellness.dine,
        //   }
        // )
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={12}>
                    ...
                    <TextField
                      ...
                      name="section_name"
                      label="Section Title"
                      value={spaWellness.banner.section_name}
                      variant="outlined"
                      fullWidth
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={9}>
                    ...
                    <TextField
                      ...
                      name="section_name"
                      label="Section Title"
                      value={spaWellness.intro.section_name}
                      variant="outlined"
                      fullWidth
